...
export default function GlobalEffects() {
  ...
  return (
    <>
      ...
      {/* Cursor Spotlight Glow - Rendered on top of everything to ensure it isn't hidden by opaque sections */}
      <div
        className="fixed inset-0 z-[40] pointer-events-none transition-all duration-300 ease-out"
        style={{
